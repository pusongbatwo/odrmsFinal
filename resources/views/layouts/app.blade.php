...
@media (max-width: 480px) {
    ...
    .form-title {
        font-size: 24px;
                ...
                /* Validation styles (used by login form for field-specific errors) */
                .is-invalid {
                ...
                /* Small helper: ensure the inline feedback is readable on custom designs */
                .login-form .invalid-feedback {
                    display: block;
                }

                        /* Optional: style the login button and inputs lightly to integrate */
                        /* Move the icon slightly and ensure inputs have enough left padding so text/placeholder won't overlap the icon */
                        .input-with-icon i {
                                left: 12px;
                        }

                        .input-with-icon input {
                            padding: 12px 15px 12px 45px; /* top right bottom left */
